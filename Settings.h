...
// ****************************************************************************************************************************
#elif defined(ADDED_PUSH_BUTTON_MANUALLY)

#warning "This will created custom for any board whichdoes have or does not have a button. Connect a push button to gpio0 <> GND (If you know your boards BOOT GPIO pin then you can just enter the pin no on the place of given BOARD_BUTTON_PIN )"

#define BOARD_BUTTON_PIN            16   // Pin where user button is attached use PUSH BUTTON on given pin no or you can change pin no
#define BOARD_BUTTON_ACTIVE_LOW     true  // true if button is "active-low"

#define BOARD_LED_PIN               2   // Set LED pin - if you have a single-color LED attached (2 no is inbuilt led)
